...
with_src = [l for l in rows if len([c for c in l.split("|") if c.strip()]) >= 3 and re.search(r"(drive|gopure|\.md|\.html|\.docx|\.pdf|http|Drive|landing|advertorial|MSDS|Stylebook|Карта|Аналіз|Исследование|VSL|статья|article)", l, re.I)]
